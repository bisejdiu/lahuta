...
unsigned int TMaligner::normalization(TMScoreThrMode mode, unsigned int alignmentLen, unsigned int queryLen, unsigned int targetLen){
    if (mode == TMScoreThrMode::alignment) {
        return alignmentLen;
    } else if (mode == TMScoreThrMode::query) {
        return queryLen;
    } else if (mode == TMScoreThrMode::target) {
        return targetLen;
    } else if (mode == TMScoreThrMode::min) {
