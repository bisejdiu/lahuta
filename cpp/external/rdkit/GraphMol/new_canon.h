...
void ActivatePartitions(unsigned int nAtoms, int *order,
                                              int *count, int &activeset,
                                              int *next, int *changed);

void rankMolAtoms(const ROMol &mol,
...
void chiralRankMolAtoms(const ROMol &mol,
                                              std::vector<unsigned int> &res);

void initCanonAtoms(const ROMol &mol,
