...
def luni() -> Generator[Luni, None, None]:
    pdb_class = X2 
...
def test_attributes(luni: Luni, pdb_class: type[BaseFile], pdb_name: str) -> None:
    ...
    assert unique_join_counts_sum(resnames) == (
        "ALAARGASNASPCYSGLNGLUGLYHECHISILELEULYSMETPHEPROSERTHRTRPTYRVAL", 1249
    )
