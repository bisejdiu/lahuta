#ifndef LAHUTA_PIPELINE_DSL_BUILDER_HPP
#define LAHUTA_PIPELINE_DSL_BUILDER_HPP

#include <memory>
#include <utility>

#include "pipeline/core/emitter.hpp"
#include "pipeline/dsl/dsl.hpp"
#include "pipeline/dsl/task_traits.hpp"
  ...
  struct with_source {
    ...
    struct with_task {
      ...
      auto outputs(SinkStages &...sinks) && { // only lvalues
        static_assert(is_task_v<Task>,
                      "pipe builder: Task must define input_type, result_type, and operator()");
...
#endif // LAHUTA_PIPELINE_DSL_BUILDER_HPP
