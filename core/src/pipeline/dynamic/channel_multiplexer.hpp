#ifndef LAHUTA_PIPELINE_DYNAMIC_CHANNEL_MULTIPLEXER_HPP
#define LAHUTA_PIPELINE_DYNAMIC_CHANNEL_MULTIPLEXER_HPP
...
#endif // LAHUTA_PIPELINE_DYNAMIC_CHANNEL_MULTIPLEXER_HPP
