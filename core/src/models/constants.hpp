...
constexpr std::array<int, 4>  gly_hyb = {3, 4, 3, 3};
...
constexpr std::array<int, 5>  ala_hyb = {3, 4, 3, 4, 3};
...
constexpr std::array<int, 7>  val_hyb = {3, 4, 3, 4, 3, 4, 4};
...
constexpr std::array<int, 8>  leu_hyb = {3, 4, 3, 4, 3, 4, 4, 4};
...
constexpr std::array<int, 8>  ile_hyb = {3, 4, 3, 4, 3, 4, 4, 4};
...
constexpr std::array<int, 6>  ser_hyb = {3, 4, 3, 4, 3, 4};
...
constexpr std::array<int, 7>  thr_hyb = {3, 4, 3, 4, 3, 4, 4};
...
constexpr std::array<int, 6>  cys_hyb = {3, 4, 3, 4, 3, 4};
...
constexpr std::array<int, 8>  met_hyb = {3, 4, 3, 4, 3, 4, 4, 4};
...
constexpr std::array<int, 7>  pro_hyb = {3, 4, 3, 4, 3, 4, 4};
...
constexpr std::array<int, 11> phe_hyb = {3, 4, 3, 4, 3, 3, 3, 3, 3, 3, 3};
...
constexpr std::array<int, 12> tyr_hyb = {3, 4, 3, 4, 3, 3, 3, 3, 3, 3, 3, 3};
...
constexpr std::array<int, 14> trp_hyb = {3, 4, 3, 4, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3};
...
constexpr std::array<int, 10> his_hyb = {3, 4, 3, 4, 3, 3, 3, 3, 3, 3};
...
constexpr std::array<int, 9>  glu_hyb = {3, 4, 3, 4, 3, 4, 3, 3, 3};
...
constexpr std::array<int, 8>  asp_hyb = {3, 4, 3, 4, 3, 3, 3, 3};
...
constexpr std::array<int, 8>  asn_hyb = {3, 4, 3, 4, 3, 3, 3, 3};
...
constexpr std::array<int, 9>  gln_hyb = {3, 4, 3, 4, 3, 4, 3, 3, 3};
...
constexpr std::array<int, 9>  lys_hyb = {3, 4, 3, 4, 3, 4, 4, 4, 4};
...
constexpr std::array<int, 11> arg_hyb = {3, 4, 3, 4, 3, 4, 4, 3, 3, 3, 3};
