...
#ifndef LAHUTA_PIPELINE_SINK_LMDB_HPP
#define LAHUTA_PIPELINE_SINK_LMDB_HPP
...
//
// - Payload is a binary serialization of analysis::ModelRecord.
...
public:
  ...
  void write(EmissionView e) override {
    using analysis::ModelRecord;
    std::lock_guard<std::mutex> lk(mu_);
    const auto rec = serialization::Serializer<fmt::binary, ModelRecord>::deserialize(e.payload.data(),
                                                                                      e.payload.size());
...
#endif // LAHUTA_PIPELINE_SINK_LMDB_HPP
