...
extern const std::string _chiralPermutation;  // int
...
extern const std::string OxidationNumber;  // int
...
extern const std::string molStereoCare;      // int
...
extern const std::string molSubstCount;      // int
extern const std::string molAttachPoint;     // int
extern const std::string molAttachOrder;     // int
extern const std::string molAtomClass;       // string
extern const std::string molAtomSeqId;       // int
extern const std::string molRxnExactChange;  // int
extern const std::string molReactStatus;     // int
extern const std::string molFileLinkNodes;   // string
extern const std::string _fromAttachPoint;   // int

extern const std::string _MolFileRLabel;  // unsigned int
...
extern const std::string _MolFileBondEndPts;  // string
extern const std::string _MolFileBondAttach;  // string
extern const std::string
...
extern const std::string _NonExplicit3DChirality;  // int
...
extern const std::string reactantAtomIdx;
extern const std::string reactionMapNum;
...
// molecule drawing
extern const std::string _displayLabel;   // string
extern const std::string _displayLabelW;  // string
...
extern const std::string molNote;
extern const std::string atomNote;
extern const std::string bondNote;
extern const std::string _isotopicHs;
...
//! third vector
void Union(const INT_VECT &r1, const INT_VECT &r2,
                                  INT_VECT &res);

//! \brief calculate the intersection of two INT_VECTs and put the results in a
//! third vector
void Intersect(const INT_VECT &r1, const INT_VECT &r2,
                                      INT_VECT &res);
