...
def example_self_hydrophobic_like(top: lxx.Topology) -> None:
    ...
    hydrophobic_atom_selector = atoms(lambda atom_rec: atom_rec.type.has(lxx.AtomType.Hydrophobic))
...
def example_cross_cation_pi_like(top: lxx.Topology) -> None:
    ...
    charged_group_selector = groups(lambda g: g.a_type == lxx.AtomType.PositiveCharge or g.a_type == lxx.AtomType.NegativeCharge)
