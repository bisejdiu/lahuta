...
class LahutaSystem:
    ...
    # def filter(self) -> LahutaSystem: ...
    # def filter_luni(self, indices: list[int]) -> LahutaSystem: ...
...
@overload
def process_files(files: list[str], n_jobs: int, use_spinner: bool = True) -> dict[str, LahutaSystem]: ...
...
class LahutaMapper:
    ...
    def get_luni(self, type: TopologyMapper.MappingType) -> LahutaSystem: ...  # noqa: A002
