...
namespace numpy = lahuta::numpy;

using LuniResultType    = lahuta::PropertyResult<std::vector<int>, std::vector<std::string>, std::vector<RDGeom::Point3D>>;
using LuniAnalyzer      = lahuta::PropertyAnalyzer<lahuta::Luni>;
using LuniFileProcessor = lahuta::FileProcessor<lahuta::Luni, LuniAnalyzer>;

using LuniIdentityAnalyzer  = lahuta::IdentityAnalyzer<lahuta::Luni>; // FIX: a temporary solution
using LuniFileProcessor2    = lahuta::FileProcessor<lahuta::Luni, LuniIdentityAnalyzer>;
...
py::array get_names    (const LuniResultType &result) { return numpy::string_array_1d(result.get<PropertyKey::Names>()); }
py::array get_indices  (const LuniResultType &result) { return numpy::as_numpy_copy(result.get<PropertyKey::Indices>()); }
py::array get_elements (const LuniResultType &result) { return numpy::string_array_1d(result.get<PropertyKey::Elements>()); }
py::array get_positions(const LuniResultType &result) { return numpy::positions_copy_f32(result.get<PropertyKey::Positions>()); }
