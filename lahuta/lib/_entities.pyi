...
from lahuta.lib._lahuta import Atom, AtomType, Flags, LahutaCPP, NSResults_, Point3D
...
class AtomEntity(_EntityInterface):
    ...
    @overload
    def __init__(self, luni: LahutaCPP, atom_index: int, atom_type: AtomType, center: Point3D, index: int) -> None: ...
    @overload
...
class RingEntity(_EntityInterface):
    ...
    @overload
    def __init__(self, luni: LahutaCPP, atom_ids: list[int], center: Point3D, normal: Point3D, index: int) -> None: ...
    @overload
...
class GroupEntity(_EntityInterface):
    ...
    @overload
    def __init__(self, luni: LahutaCPP, atom_ids: list[int],  atom_type: AtomType, group: FeatureGroup, center: Point3D, index: int) -> None: ...
    @overload
