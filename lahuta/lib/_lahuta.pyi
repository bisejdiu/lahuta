...
class LuniResultType:
    ...
    @overload
    def get(self, key: Literal[PropertyKey.Names]) -> list[str]: ...
    @overload
    def get(self, key: Literal[PropertyKey.Indices]) -> list[int]: ...
    @overload
    def get(self, key: Literal[PropertyKey.Elements]) -> list[str]: ...
    @overload
    def get(self, key: Literal[PropertyKey.Positions]) -> list[Point3D]: ...

    def get(self, key: PropertyKey) -> list[str] | list[int] | list[Point3D]: ...

    @overload
    def __getitem__(self, key: Literal[PropertyKey.Names]) -> list[str]: ...
    @overload
    def __getitem__(self, key: Literal[PropertyKey.Indices]) -> list[int]: ...
    @overload
    def __getitem__(self, key: Literal[PropertyKey.Elements]) -> list[str]: ...
    @overload
    def __getitem__(self, key: Literal[PropertyKey.Positions]) -> list[Point3D]: ...

    def __getitem__(self, key: PropertyKey) -> list[str] | list[int] | list[Point3D]: ...
