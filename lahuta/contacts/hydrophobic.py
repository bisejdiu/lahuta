...
class HydrophobicContacts(ContactAnalysis):
    ...
    Attributes:
        ...
        distance (float): The maximum distance to consider for a hydrophobic contact. This value is retrieved
            from the 'hydrophobic' entry of the global CONTACTS dictionary.

    Methods:
        compute() -> NeighborPairs: Computes and returns the hydrophobic contacts, utilizing the F.hydrophobic_neighbors function.
