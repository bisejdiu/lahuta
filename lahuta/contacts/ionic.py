...
class IonicContacts(ContactAnalysis):
    ...
    Attributes:
        ...
        distance (float): The maximum distance to consider for an ionic contact. This value is retrieved from
            the 'ionic' entry of the global CONTACTS dictionary.

    Methods:
        compute() -> NeighborPairs: Computes and returns the ionic contacts, utilizing the F.ionic_neighbors function.
