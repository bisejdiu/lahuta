...
ATOM_TYPES = {
    ...
    "xbond donor": {"donor": "[Cl,Br,I;X1;$([Cl,Br,I]-[#6])]"},
    "weak hbond acceptor": {
        # SAME AS HBA
        "acceptor": "[#8,#9,$([#16;H0,H1;v2,v1]),$([N;v3;!$(N-*=!@[O,N,P,S]);!$(N-!@a);!$([NH]=!@*)]),$([nH0;+0])]",
        "enol": "[$([nH]:@c(=O))]",
    ...
    "carbonyl oxygen": {"oxygen": "[$([OH0]=[CX3,c]);!$([OH0]=[CX3,c]-[OH,O-])]"},
    "carbonyl carbon": {"carbon": "[$([CX3,c]=[OH0]);!$([CX3,c](=[OH0])-[OH,O-])]"},
    "aromatic": {
