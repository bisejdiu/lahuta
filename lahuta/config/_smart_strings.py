...
[HBOND_ACCEPTOR_SMARTS](smarts_defs.md#lahuta.config._smart_strings.HBOND_ACCEPTOR_SMARTS).
"""
...
[HBOND_DONOR_SMARTS](smarts_defs.md#lahuta.config._smart_strings.HBOND_DONOR_SMARTS).
"""
...
[WEAK_HBOND_DONOR](smarts_defs.md#lahuta.config._smart_strings.WEAK_HBOND_DONOR).
"""

SMARTS_STR_XBD = "[Cl,Br,I;X1;$([Cl,Br,I]-[#6])]"
"""
Type: `str`: Halogen bond donor. Helps define
[XBOND_DONOR](smarts_defs.md#lahuta.config._smart_strings.XBOND_DONOR).
"""
...
[POSITIVELY_IOINISABLE_SMARTS](smarts_defs.md#lahuta.config._smart_strings.POSITIVELY_IOINISABLE_SMARTS).
"""
...
[NEG_IONISABLE](smarts_defs.md#lahuta.config._smart_strings.NEG_IONISABLE).
"""
...
[HYDROPHOBE](smarts_defs.md#lahuta.config._smart_strings.HYDROPHOBE).
"""
SMARTS_STR_CARBONYL_OXYGEN = "[$([OH0]=[CX3,c]);!$([OH0]=[CX3,c]-[OH,O-])]"
"""
Type: `str`: Carbonyl oxygen. Helps define
[CARBONYL_OXYGEN](smarts_defs.md#lahuta.config._smart_strings.CARBONYL_OXYGEN).
"""
SMARTS_STR_CARBONYL_CARBON = "[$([CX3,c]=[OH0]);!$([CX3,c](=[OH0])-[OH,O-])]"
"""
Type: `str`: Carbonyl carbon. Helps define
[CARBONYL_CARBON](smarts_defs.md#lahuta.config._smart_strings.CARBONYL_CARBON).
"""
...
!!! tip "Definitions"
    - `arom_4`: Aromatic 4 ([source](smarts_defs.md#lahuta.config._smart_strings.SMARTS_STR_AROMATIC_4))
    - `arom_5`: Aromatic 5 ([source](smarts_defs.md#lahuta.config._smart_strings.SMARTS_STR_AROMATIC_5))
    - `arom_6`: Aromatic 6 ([source](smarts_defs.md#lahuta.config._smart_strings.SMARTS_STR_AROMATIC_6))
    - `arom_7`: Aromatic 7 ([source](smarts_defs.md#lahuta.config._smart_strings.SMARTS_STR_AROMATIC_7))
    - `arom_8`: Aromatic 8 ([source](smarts_defs.md#lahuta.config._smart_strings.SMARTS_STR_AROMATIC_8))
"""
