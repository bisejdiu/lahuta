...
CXXFLAGS = -DDYNAMIC_CRC_TABLE -I$(ROOT)/lahuta/bond_order -I$(ROOT)/include -I$(ROOT)/third_party -I$(ROOT)/third_party/zlib -I$(CONDA_PREFIX)/include/rdkit -I/home/bisejdiu/tmp/dpnblist/only_cpu/ -O2
