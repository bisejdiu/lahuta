...
CXXFLAGS = -DDYNAMIC_CRC_TABLE -I$(INCLUDE_DIR) -Ibond_table -I$(ROOT)/lahuta/bond_order -I$(ROOT)/third_party -I$(ROOT)/third_party/zlib -I$(CONDA_PREFIX)/include/rdkit -O3
