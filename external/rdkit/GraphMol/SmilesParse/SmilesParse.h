...
std::unique_ptr<RDKit::RWMol> MolFromSmiles(
    const std::string &smi,
    const SmilesParserParams &params = SmilesParserParams());
std::unique_ptr<RDKit::RWMol> MolFromSmarts(
    const std::string &sma,
    const SmartsParserParams &params = SmartsParserParams());

std::unique_ptr<RDKit::Atom> AtomFromSmiles(
    const std::string &smi);
std::unique_ptr<RDKit::Bond> BondFromSmiles(
    const std::string &smi);

std::unique_ptr<RDKit::Atom> AtomFromSmarts(
    const std::string &sma);
std::unique_ptr<RDKit::Bond> BondFromSmarts(
    const std::string &sma);
