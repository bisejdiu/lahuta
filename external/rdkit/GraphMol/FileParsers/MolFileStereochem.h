...
void DetectAtomStereoChemistry(RWMol &mol,
...
void markUnspecifiedStereoAsUnknown(ROMol &mol,
                                                             int confId = -1);
...
*/
void translateChiralFlagToStereoGroups(
    ROMol &mol,
